              ...
              <br/><br/>
               ...
               <br/> 
                  ...
                  />
                    ...
                    <br/> 
                    <div >
                        <a  href="/calcFront"><input type="submit" value="Calculate" id="calcBtn" className="btn btn-primary" /></a>
                        <br/><br/>
                        <a href="/calcFront"><input type="submit" value="Genarate Report" id="calcBtn2" className="btn btn-primary" /></a>
                    </div>
